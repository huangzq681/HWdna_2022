...
forcs = ['piControl']
ensems = ['r1i1p1f1']
starts1 = [str(i * 10 + 1) + '0101' for i in range(520,620)]
ends1 = [str(i * 10 + 10) + '1231' for i in range(520,620)]

zg0_ds = xr.open_dataset('zg_day_CanESM5_piControl_r1i1p1f1_gn_52010101-52101231.nc')
zg0 = zg0_ds['zg']
