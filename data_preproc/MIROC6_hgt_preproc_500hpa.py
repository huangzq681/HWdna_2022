...
starts1 = [str(i)+'0101' for i in range(1950,2015)]
ends1 = [str(i)+'1231' for i in range(1950,2015)]
starts2 = [str(i)+'0101' for i in range(1950,2015)]
ends2 = [str(i)+'1231' for i in range(1950,2015)]
starts3 = [str(i)+'0101' for i in range(2050,2101)]
ends3 = [str(i)+'1231' for i in range(2050,2101)]

zg0_ds = xr.open_dataset('zg_day_MIROC6_hist-GHG_r1i1p1f1_gn_19510101-19511231.nc')
zg0 = zg0_ds['zg']
