...
forcs = ['piControl']
ensems = ['r1i1p1f1']
starts1 = [str(i) + '0101' for i in range(3200,3700)]
ends1 = [str(i) + '1231' for i in range(3200,3700)]

zg0_ds = xr.open_dataset('zg_day_MIROC6_piControl_r1i1p1f1_gn_32000101-32001231.nc')
zg0 = zg0_ds['zg']
